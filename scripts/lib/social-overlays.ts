...
<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      body {
        ...
        min-height: 100vh;
        background:
          radial-gradient(circle at 15% 12%, ${options.theme.homeColor}88, transparent 30%),
          radial-gradient(circle at 85% 22%, ${options.theme.awayColor}88, transparent 30%),
          linear-gradient(135deg, #030608, #07111a 58%, #050607);
      }
      .template-stage {
        ${styleVars(options.theme)}
  ...
  <body>
    <main class="template-stage hf-template-shell">
      <div class="template-frame">${options.body}</div>
    </main>
  </body>
</html>
`;
