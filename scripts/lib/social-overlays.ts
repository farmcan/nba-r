  ...
  <head>
    ...
    <style>
      ...
      .template-frame.phone-showcase {
        ...
        transform: rotateX(3deg) rotateY(-7deg) rotateZ(-1.2deg) translate3d(0, -8px, 0);
        animation: hf-device-float 8s ease-in-out infinite;
      }
      .template-frame.phone-showcase::before {
        ...
        background:
          linear-gradient(90deg, rgba(255,255,255,0.14), rgba(33,38,45,0.74) 6%, rgba(5,7,10,0.82) 18%, rgba(0,0,0,0.84)),
          linear-gradient(180deg, rgba(255,255,255,0.14), transparent 28%, rgba(0,0,0,0.42));
        box-shadow:
          36px 44px 70px rgba(0,0,0,0.48),
          14px 12px 0 rgba(16,21,28,0.62),
          inset 0 0 0 1px rgba(255,255,255,0.16);
        opacity: 0.86;
        transform: translate3d(20px, 14px, -56px);
      }
      .template-frame.phone-showcase::after {
        ...
        border-radius: var(--device-radius);
        background:
          linear-gradient(112deg, transparent 0 30%, rgba(255,255,255,0.18) 39%, rgba(255,255,255,0.04) 46%, transparent 56%),
          radial-gradient(circle at 20% 9%, rgba(255,255,255,0.14), transparent 17%);
      ...
      @keyframes hf-device-float {
        ...
        50% {
          transform: rotateX(3.5deg) rotateY(-4deg) rotateZ(-0.4deg) translate3d(6px, -20px, 0);
        }
      }
    </style>
  </head>
